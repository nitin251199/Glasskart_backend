...
router.post('/editpictures', upload.single("picture"), function (req, res, next) {
  console.log(req.body)
  console.log(req.file)
  pool.query("update productpictures set image=? where finalproductid=?", [req.originalname, req.body.finalproductid], function (error, result) {
    if (error) {
      console.log(error);
...
router.post('/checkfinalproduct', upload.any(), function (req, res) {
  console.log(req.body)
...
router.get('/fetchallfinalproducts', function (req, res, next) {
  var q = "select p.*, (select productname from product where productid = p.productid )as productname,(select colorname from color where colorid =p.colorid )as colorname from finalproduct  as p"
