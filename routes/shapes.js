...
router.post('/insertshape',upload.single("adpicture"), function(req, res, next) {
  console.log("BODY:", req.body);
  console.log("FILE", req.file);
  pool.query("insert into shapes (shapename,adpicture,status) values(?,?,?)",
  [req.body.shapename,req.body.myfilename,req.body.status],function(error,result){
      if(error)
      { console.log(error)
...
router.post('/updateshape', function(req, res, next) {
  console.log("BODY:", req.body);
